 ...
 *
 * Solved by: @iTzVoko
 * Note: This code uses ternary operator to simplify the solution.
 * 		 The zero (0) at the end of ternary operators doesn't do anything.
 */
#include <iostream>
...
int main()
{
	...
	if (num1 < 20 && num1 % 2 == 0) result += num1;
	if (num2 < 20 && num2 % 2 == 0) result += num2;
	if (num3 < 20 && num3 % 2 == 0) result += num3;
	if (num4 < 20 && num4 % 2 == 0) result += num4;
